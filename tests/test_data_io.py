...
class TestYahooFinanceDataFetching:
    ...
    def test_fetch_adj_close_success(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(main, 'fetch_data_with_retry', mock_fetch)
        
        result = main.fetch_adj_close('TEST', 3, use_cache=False)
    ...
    def test_fetch_adj_close_with_cache_hit(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(main, 'load_cache', lambda: cache_data)
        ...
        result = main.fetch_adj_close('TEST', 3, use_cache=True)
    ...
    def test_fetch_adj_close_with_cache_miss(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(main, 'load_cache', lambda: None)
        ...
        monkeypatch.setattr(main, 'save_cache', mock_save_cache)
    ...
    def test_fetch_adj_close_empty_data_raises_error(self, monkeypatch, tmp_path):
        ...
        with pytest.raises(RuntimeError, match="Failed to fetch any valid data"):
            main.fetch_adj_close('INVALID', 3, use_cache=False)
    ...
    def test_fetch_data_with_retry_success(self, monkeypatch):
        ...
        with patch('yfinance.download') as mock_download:
            ...
            result = main.fetch_data_with_retry('TEST', interval='1d', period='3y', retries=1, delay=0)
    ...
    def test_fetch_data_with_retry_empty_response(self, monkeypatch):
        ...
        with patch('yfinance.download') as mock_download:
            ...
            result = main.fetch_data_with_retry('INVALID', interval='1d', period='3y', retries=1, delay=0)
    ...
    def test_fetch_data_with_retry_network_error(self, monkeypatch):
        ...
        with patch('yfinance.download') as mock_download:
            ...
            result = main.fetch_data_with_retry('TEST', interval='1d', period='3y', retries=2, delay=0)
    ...
    def test_fetch_multiple_symbols(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(main, 'fetch_data_with_retry', mock_fetch)
        monkeypatch.setattr(main, 'save_cache', lambda x: None)
        
        qqq_result = main.fetch_adj_close('QQQ', 3, use_cache=False)
        tqqq_result = main.fetch_adj_close('TQQQ', 5, use_cache=False)
...
class TestCSVLogging:
    ...
    def test_append_signal_log_new_file(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(main, 'SIGNAL_LOG_CSV', log_file)
...
class TestDataIntegration:
    ...
    def test_fetch_and_cache_workflow(self, monkeypatch, tmp_path):
        ...
        result1 = main.fetch_adj_close('QQQ', 3, use_cache=True)
        ...
        result2 = main.fetch_adj_close('QQQ', 3, use_cache=True)
    ...
    def test_cache_invalidation(self, monkeypatch, tmp_path):
        ...
        # Fetch with cache
        result1 = main.fetch_adj_close('TEST', 3, use_cache=True)
        assert call_count[0] == 1
        
        # Fetch without cache (should fetch again)
        result2 = main.fetch_adj_close('TEST', 3, use_cache=False)
